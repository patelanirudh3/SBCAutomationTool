...
function parseRaw(raw: RawVMFormValues): Partial<VMConfig> {
  ...
  return {
    ...
    failover_enabled: raw.dual_registration_enabled || undefined,
    failover_mode: raw.dual_registration_enabled ? raw.failover_mode : undefined,
    auto_failback_enabled: raw.dual_registration_enabled ? raw.auto_failback_enabled : undefined,
    failback_delay_seconds: raw.dual_registration_enabled && raw.auto_failback_enabled ? (parseInt(raw.failback_delay_seconds) || undefined) : undefined,
